...
@implementation PrimeiraFaseLayer

@synthesize lblPoints, _player;
...
-(void)spriteMoveFinished:(id)sender {
    ...
    if (_player.lifes <= 0) {
        ...
        [self schedule:@selector(gameOverLose:)];
        /*
...
-(void)spriteMoveFinishedProjectile:(id)sender {
    CCSprite *sprite = (CCSprite *)sender;
    [self removeChild:sprite cleanup:YES];
    ...
    if (sprite.tag == 1) { // target
        ...
        [_projectiles removeObject:sprite];
        [[Common appDelegate] set_pointMade:[[Common appDelegate] _pointMade]-2];
...
-(void)stateFinished:(id)sender {
    ...
    if (_player.lifes > 0) {
        ...
        [[Common appDelegate] set_player:_player];
        
        [MenuManager newFase:@"First phase was easy..." fase:2];
...
-(id) init
{
	if( (self=[super initWithColor:ccc4(255,255,255,255)] )) {
        ...
        [[Common appDelegate] set_pointMade:0];
        
        _targets = [[NSMutableArray alloc] init];
        _projectiles = [[NSMutableArray alloc] init];
        
        [[Common appDelegate] set_player:[Player1 newPlayer]];
        ...
        self.lblPoints = [CCLabelTTF labelWithString:[NSString stringWithFormat:@"%d points", [[Common appDelegate] _pointMade]] fontName:@"Marker Felt" fontSize:16];
        lblPoints.color = ccGREEN;
