...
@implementation SegundaFaseLayer
...
+(CCScene *) scene
{
	...
	SegundaFaseLayer *layer = [SegundaFaseLayer node];
...
-(void)stateFinished:(id)sender {
    ...
    if (_player.lifes > 0) {
        ...
        */
        ...
        [MenuManager newFase:@"You were lucky so far..." fase:3];
    }
...
-(id) init
{
	if( (self=[super initWithColor:ccc4(255,255,255,255)] )) {
        ...
        background = [CCSprite spriteWithFile:@"background2.jpg"];
        background2 = [CCSprite spriteWithFile:@"background2.jpg"];
